NutSignatures = list(
  ...
  "Vitamin_D_GWAS" = c("GC", "CALCB", "CYP2R1", "ZPR1", "HAL", "ALDH1A2",
                  "LIPC", "SMARCA4", "SULT2A1", "PADI1", "CCDST", "SMCP", "LCE7A", "BCAS1", 
                  "CYP24A1", "UGT1A6", "UGT1A8", "UGT1A9", "UGT1A10", "UGT1A7", "UGT1A5", 
                  "UGT2B7", "SPOPLP1", "GC", "LINC00536", "PDE3B", "ACTE1P", "NADSYN1", 
                  "NPFFR2", "PACRG", "LINC01824", "LINC01247", "PVT1", "TMEM183AP4", "PCNX1", 
                  "DHCR7"),
  ...
  "Vitamin_D_MSigDB_Filtered" = c("A1BG", "ACSM2A", "AFM", "AGXT", "AHSG", "AMBP", "ANG", 
                                  "APOA1", "APOA2", "APOA5", "APOB", "APOC1", "APOC3", "APOE", 
                                  "APOH", "ASGR1", "ASGR2", "AZGP1", "BAAT", "C1R", "C1S", "C3", 
                                  "C9", "CES1", "CFB", "CFH", "CFHR3", "CLU", "CP", "CPS1", 
                                  "CYP2E1", "CYP4F3", "CYP8B1", "DCXR", "EPHX1", "F12", "F2", 
                                  "FGA", "FGB", "FGG", "FGL1", "FTCD", "GPT2", "HP", "HPN", 
                                  "HPX", "HRG", "IFITM3", "IGF2", "IGFBP1", "IGFBP4", "ITIH1", 
                                  "ITIH3", "KLF2", "KLF4", "KNG1", "LRG1", "MAT1A", "MLXIPL", 
                                  "MST1", "MT2A", "NNMT", "ORM1", "ORM2", "PLG", "PTMS", "RARRES2", 
                                  "SELENBP1", "SERPINA1", "SERPINA3", "SERPINC1", "SERPIND1", 
                                  "SERPINF1", "SERPINF2", "SERPING1", "SGK1", "SLC27A5", "SULT2A1",
                                  "TF", "TMEM176A", "TMEM176B", "VTN"),
  "Vitamin_D_MSigDB_CrossValidation_6" = c("LINGO1", "SIX4", "CHRM1", "ATG9B", "VARS2", "LOC100131635")
)
